package TroysCode;
import HexNations.Help;
import HexNations.MainMenu;
import HexNations.NewGameCreator;
import HexNations.Server;
...
public class hub
	{
		...
		public static final NewGameCreator gameCreator = new NewGameCreator();
		public static final Server background = new Server();
